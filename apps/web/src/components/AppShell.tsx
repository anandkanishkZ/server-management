...
const NAV_ITEMS: { label: string; icon: ReactNode; active?: boolean }[] = [
  ...
  { label: "Logs", icon: icon(<><path d="M6 3h9l5 5v13a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1Z" /><path d="M9 12h6M9 16h6M9 8h3" /></>) },
  { label: "Security", icon: icon(<path d="M12 3 4 6v6c0 4.5 3.2 7.7 8 9 4.8-1.3 8-4.5 8-9V6l-8-3Z" />) },
